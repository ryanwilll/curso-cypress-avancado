describe('Hacker Stories', () => {
  ...
  context('Hitting the real API', () => {
    ...
    it('searches via the last searched term', () => {
      ...
      cy.getLocalStorage('search').should('be.eq', newTerm);

      cy.get(`button:contains(${initialTerm})`).should('be.visible').click();
      cy.wait('@getStories');
      cy.getLocalStorage('search').should('be.eq', initialTerm);
      ...
      context('List of stories', () => {
        ...
        it('shows the right data for all rendered stories', () => {
          stories.hits.forEach((story, index) => {
            ...
            cy.get(`.item a:contains(${story.title})`).should(
              'have.attr',
              'href',
              story.url,
            );
      ...
      context('Last searches', () => {
        it('shows a max of 5 buttons for the last searched terms', () => {
          ...
          Cypress._.times(6, () => {
            ...
            cy.getLocalStorage('search').should('be.eq', randomWord);
          });
